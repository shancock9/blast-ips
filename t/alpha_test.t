...
#          [ 1, 1.5, 0.77524613 ],
        ...
        #'symmetry=2; gamma=1.8' => 0.402941901,
        #'symmetry=1; gamma=1.8' => 0.45813829,
        #'symmetry=0; gamma=1.8' => 0.242077257,
        ...
        #'symmetry=2; gamma=4' => 0.0766253961,
        #'symmetry=1; gamma=4' => 0.0811006953,
        #'symmetry=0; gamma=4' => 0.0383442271,

        [ 2, 5 , 0.050894114],
        [ 1, 5,  0.0524980647],
        #[0, 5 , 0.0241337021],

        #'symmetry=2; gamma=6' => 0.0366750787,
        #'symmetry=1; gamma=6' => 0.0369407716,
        #'symmetry=0; gamma=6' => 0.0166211108,
